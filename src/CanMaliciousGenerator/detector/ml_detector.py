...
class Detector:
    ...
    def classify(self, dataset_train, size_dataset=700000, dataset_test=None, verbose=True, size_train = 700000, file_name="labeled_dataset.txt", label='malicious', drop=['malicious','byte5','byte6','byte7','byte8']):
